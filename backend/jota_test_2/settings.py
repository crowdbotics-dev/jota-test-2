"""
Django settings for jota_test_2 project.
...
WSGI_APPLICATION = 'jota_test_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jota_test_2 API",
    "DESCRIPTION": "API documentation for jota_test_2 App",
    "VERSION": "v1",
}
